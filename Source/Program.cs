namespace Malovani
{
    class Program
    {
        ...
        static PoziceKurzoru VlivOvladaniNaObrazek(ConsoleKeyInfo novaKlavesa, char[,] obrazek, char[] whitelist, PoziceKurzoru kurzor, PoziceKurzoru max)
        {
            ...
            {
                obrazek[kurzor.Y, kurzor.X] = novaKlavesa.KeyChar;
            }
        ...
        {
            if (novaKlavesa.Key == ConsoleKey.RightArrow && kurzor.X < max.X + 1)
            {
                kurzor.X = kurzor.X + 1;
            }
            ...
            else if (novaKlavesa.Key == ConsoleKey.DownArrow && kurzor.Y < max.Y - 1)
            {
                kurzor.Y = kurzor.Y + 1;
            }
        ...
        static char[,] ZiskatObrazek()
        {
            ...
            throw new Exception("Došlo k neočekávané situaci.");
        }
